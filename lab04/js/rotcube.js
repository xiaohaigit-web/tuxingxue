...
window.onload = function initCube() 
{
	...
	moveLoc = gl.getUniformLocation(program, "move_");
	gl.uniform3fv(moveLoc, move);
	surLoc = gl.getUniformLocation(program,'sur_');
	gl.uniform3fv(surLoc, sur);
	...
	document.getElementById("z1").onclick = function () {
	    move[2]+=0.2;
	}
